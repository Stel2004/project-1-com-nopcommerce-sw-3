...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Vaja");
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Wembley");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "HA9 7AJ");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "+447899028393");
        Thread.sleep(2000);
