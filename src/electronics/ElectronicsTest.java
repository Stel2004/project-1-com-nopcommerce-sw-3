...
public class ElectronicsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() {
        ...
        //1.2 Mouse Hover on “Cell phones” and "Click"
        mouseHoverAndClickOnElement(By.xpath("//ul[@class='top-menu notmobile']/li[2]/ul/li[2]"));
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_City"), "Amazpn");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Haunted ");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "KT20");
